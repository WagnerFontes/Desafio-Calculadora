...
public class CalculadoraPage extends CalculadoraSteps {
	...
	public void setValorCampo2(String campo2) {
		driver.findElement(By.id("com.example.leonardomenezes.simplecalculatorandroid:id/android_field_second_number")).sendKeys(campo2);
	...
	public void resultadoSoma() {
		...
		String resultado = driver.findElement(By.id("com.example.leonardomenezes.simplecalculatorandroid:id/android_result_text")).getText();
